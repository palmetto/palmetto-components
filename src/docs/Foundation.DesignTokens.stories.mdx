...
<ColorItem
  ...
  colors={Object.keys(color.brand.white).reduce((acc, item, i) => {
    acc[item] = Object.keys(color.brand.white).map(
      g => color.brand.white[g].value,
    )[i];
    return acc;
  }, {})}
/>
...
<ColorItem
  ...
  colors={Object.keys(color.brand.black).reduce((acc, item, i) => {
    acc[item] = Object.keys(color.brand.black).map(
      g => color.brand.black[g].value,
    )[i];
    return acc;
  }, {})}
/>
...
<ColorItem
  title="color-brand-300"
  subtitle="Light"
  colors={Object.keys(color.brand.light).reduce((acc, item, i) => {
    acc[item] = Object.keys(color.brand.light).map(
      g => color.brand.light[g].value,
    )[i];
    return acc;
  }, {})}
/>
...
<ColorItem
  title="color-brand-600"
  subtitle="Dark"
  colors={Object.keys(color.brand.dark).reduce((acc, item, i) => {
    acc[item] = Object.keys(color.brand.dark).map(
      g => color.brand.dark[g].value,
    )[i];
    return acc;
  }, {})}
/>
