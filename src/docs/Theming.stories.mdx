      ...
      return (
        ...
        >
          ...
          <Box alignItems="center" gap="sm" direction="row">
            ...
            <Button variant="tertiary">Danger</Button>
            <Button variant="primary-neutral">Primary Neutral</Button>
            <Button variant="secondary-neutral">Success Neutral</Button>
            <Button variant="tertiary-neutral">Danger Neutral</Button>
            <Button variant="primary-danger">Primary Danger</Button>
            <Button variant="secondary-danger">Success Danger</Button>
            <Button variant="tertiary-danger">Danger Danger</Button>
          </Box>
