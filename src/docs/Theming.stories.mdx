...
Palmetto Components library uses design tokens at its core. Since all design tokens are tied to CSS variables, the underlying values can be overwritten to create a custom theme.
...
Not every possible styling option is available to be customized, as the Palmetto Design System is not intended to be a fully-customizable ui library. For component-specific tokens, see docs for the specific component.
    ...
    {() => {
      ...
      return (
        ...
        >
          ...
          <TextInput id="demo" helpText="This is a themed text input" label="Text Input" />
          <RadioGroup
            title="Radio Group"
            description="This is a themed radio group"
            name="radioGroup"
