    ...
    {() => {
      ...
      return (
        ...
        >
          ...
          />
          <TextareaInputInset
            label="Textarea Input Inset"
            name="textareaInputInset"
            id="textareaInputInset"
            value={themeExampleValues.textareaValue}
            onChange={e => handleChange('textareaValue', e.target.value)}
          />
  ...
  <tbody>
    {(() => {
      const tokens = {
        ...
        'form-control-background-color': '--color-brand-white-500',
        ...
        'form-control-font-color-error': '--color-brand-danger-500',
...
import {TextareaInputInset} from 'src/components/TextareaInputInset/TextareaInputInset';
