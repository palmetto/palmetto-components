  ...
  <tbody>
    {(() => {
      const tokens = {
        ...
        'form-control-background-color-disabled': '--color-brand-grey-lightest',
        'form-control-background-color-error': '--color-brand-danger-lightest',
        ...
        'form-control-border-color-focus': '--color-brand-grey-dark',
        ...
        'form-control-font-color-disabled': '--color-brand-grey-light',
        'form-control-font-color-error': '--color-brand-danger-base',
        'form-control-font-color-error-disabled': '--color-brand-danger-200',
        'form-control-description-color': '--color-brand-grey-dark',
        'form-control-icon-color': 'form-control-placeholder-color',
        'form-control-icon-color-hover': '--color-brand-grey',
        'form-control-placeholder-color': '--color-brand-grey-light',
  ...
  <Story name="Form Theming">
    {() => {
      ...
      const customTheme = {
        ...
        '--form-control-background-color': '--color-brand-grey-100',
