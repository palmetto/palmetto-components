...
Upload multiple files with the `multiple` prop, note user is expected to select multiple files
in their finder/explorer. It will not work properly if the user clicks the button multiple times.
