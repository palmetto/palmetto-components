...
const ModalBaseComponent: React.ForwardRefExoticComponent<React.PropsWithoutRef<ModalProps>> = forwardRef<HTMLDivElement, ModalProps>((
  {
    ariaLabel,
    ariaLabelledBy,
...
export const Modal = (() => {
  const Modal = ModalBaseComponent as ModalWithStaticComponents;
