...
<Meta
  title="Components/TextareaInputFloating/Overview"
...
Use `TextareaInputFloating` to create a floating label input field. It is a controlled component, which means that you need to provide a value and an `onChange` handler to update the value.
...
<ArgsTable of={TextareaInputFloating} />
