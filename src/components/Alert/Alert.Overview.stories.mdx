  ...
  <tbody>
    {(() => {
      const tokens = {
        ...
        '--alert-default-border-color': '--color-brand-grey-300',
        ...
        '--alert-info-border-color': '--color-brand-info-300',
        ...
        '--alert-success-border-color': '--color-brand-success-300',
        ...
        '--alert-warning-border-color': '--color-brand-warning-300',
        ...
        '--alert-danger-border-color': '--color-brand-danger-300',
