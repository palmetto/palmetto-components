      ...
      return (
        <>
          {variants.map(variant => (
            <Alert message={variant} variant={variant} className="m-bottom-md" />
          ))}
        </>
      );
    }}
...
<Canvas>
  <Story name="Custom Class">
    {() => {
      return <Alert message="Hello world!" variant="success" className="m-bottom-3xl" />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Compact">
    {() => {
      return <Alert message="Compact Alerts have less padding" variant="info" isCompact />;
    }}
  </Story>
</Canvas>
