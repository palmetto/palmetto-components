...
import { computedResponsiveSize } from './TextInputSizeUtilities';
import { getInputMaskType } from './TextInputMasks';
...
export const TextInput = forwardRef<HTMLInputElement & Component, TextInputProps>(
  (
    {
      id,
      label,
