...
<Canvas>
  <Story name="Background">
    <Box gap="xs">
      <Box background="primary" padding="xs">
        primary
      </Box>
      <Box background="secondary" padding="xs">
        secondary
      </Box>
      <Box background="tertiary" padding="xs">
        tertiary
      </Box>
      <Box background="inverse" color="inverse-primary" padding="xs">
        inverse
      </Box>
      <Box background="default" padding="xs">
        default
      </Box>
      <Box background="info" padding="xs">
        info
      </Box>
      <Box background="success" padding="xs">
        success
      </Box>
      <Box background="warning" padding="xs">
        warning
      </Box>
      <Box background="danger" padding="xs">
        danger
      </Box>
    </Box>
  </Story>
...
<Canvas>
  <Story name="Border">
    <Box gap="sm" direction="row">
      <Box borderColor="separator" borderWidth="md" padding="xs">
        separator
      </Box>
      <Box borderColor="success" borderWidth="0 sm md xs" padding="xs">
        success, 0 sm md xs
      </Box>
      <Box borderColor="default" borderWidth="md" padding="xs">
        default, md
      </Box>
      <Box borderColor="info" borderWidth="md" padding="xs">
        info, md
      </Box>
      <Box borderColor="warning" borderWidth="md" padding="xs">
        warning, md
      </Box>
      <Box borderColor="danger" borderWidth="md" padding="xs">
        danger, md
      </Box>
    </Box>
  </Story>
...
<Canvas>
  <Story name="Font Color">
    <Box gap="xs">
      <Box color="body-primary">body-primary</Box>
      <Box color="body-secondary">body-secondary</Box>
      <Box color="body-tertiary">body-tertiary</Box>
      <Box color="contrast">contrast</Box>
      <Box color="inverse-primary">inverse-primary</Box>
      <Box color="inverse-secondary">inverse-secondary</Box>
...
<Canvas>
  <Story name="Font Family">
    ...
    <Box fontFamily="monospace" margin="0 0 md 0" fontSize="xl" data-chromatic="ignore">
      Monospace Font
