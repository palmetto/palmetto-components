...
All that is required to render a basic version of the SelectInput is a unique `id`, a `label`, a list of options passed to the `options` prop, and an onchange event handler passed to the `onChange` prop.
