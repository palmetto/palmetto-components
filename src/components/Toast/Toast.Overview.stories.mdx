...
<Canvas isExpanded>
  <Story name="Default">
    {() => {
      const handleClick = () => toast('Proposal saved!');
      return (
        <>
...
>>>>>>> f074530c7b8c2da248ac9fa480ffe86fd79cc64b
      };
      return (
        <>
          <Box childGap="md" direction="row">
...
<<<<<<< HEAD
          const toastId = toast.loading('Loading...', { duration: 5000000, canDismiss: false });
=======
          const toastId = toast.loading('Loading...', { duration: 50000, isDismissable: false });
>>>>>>> f074530c7b8c2da248ac9fa480ffe86fd79cc64b
        } else {
