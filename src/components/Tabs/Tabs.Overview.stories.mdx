  ...
  <tbody>
    {(() => {
      const tokens = {
        ...
        '--tabs-font-color-hover': '--color-text-primary',
        '--tabs-selected-border-color': '--color-text-primary',
        '--tabs-selected-font-color': '--color-text-primary',
        '--tabs-selected-font-color-hover': '--color-text-primary',
      };
