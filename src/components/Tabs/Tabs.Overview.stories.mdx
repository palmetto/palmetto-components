    ...
    {() => {
      ...
      return (
        <Box childGap="md">
          ...
          >
            <Tabs.Item as="a" href="#firstPanel" id="tabOneAnchor" aria-controls="firstPanel" style={{ textDecoration: 'none' }} onClick={handleClick}>
              Tab 1
            </Tabs.Item>
            <Tabs.Item as="a" href="#secondPanel" id="tabTwoAnchor" aria-controls="secondPanel" style={{ textDecoration: 'none' }} onClick={handleClick}>
              Tab 2
            </Tabs.Item>
          </Tabs>
           <TabPanels value={selectedTab}>
