    ...
    {() => {
      ...
      return (
        <Box childGap="md">
          ...
          >
            <TabsSlider.Item as="a" href="#firstPanel" id="tabOneAnchor" aria-controls="firstPanel" style={{ textDecoration: 'none' }} onClick={handleClick}>
              Tab 1
            </TabsSlider.Item>
            <TabsSlider.Item as="a" href="#secondPanel" id="tabTwoAnchor" aria-controls="secondPanel" style={{ textDecoration: 'none' }} onClick={handleClick}>
              Tab 2
            </TabsSlider.Item>
          </TabsSlider>
           <TabPanels value={selectedTab}>
            <Box padding="lg" id="firstPanel" aria-labelledby="tabOneAnchor">Here's the first tab</Box>
            <Box padding="lg" id="secondPanel" aria-labelledby="tabTwoAnchor">Here's the second tab</Box>
          </TabPanels>
        </Box>
      );
    }}
  ...
  <tbody>
    {(() => {
      const tokens = {
        ...
        '--tabs-slider-font-weight': '--size-font-weight-bold',
      };
