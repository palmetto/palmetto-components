...
<Meta
  title="Components/OptionTiles/Overview"
...
Use a OptionTiles when a user is required to select one of five or fewer options. It is ideal for this scenario because the options are displayed without having to interact. If there are more than five options, use the [SelectInput](?path=/docs/components-selectinput-overview--default-story) instead.
...
Set the direction (flex) of the tiles. This uses the same `direction` prop as the `Box` component and as such can be responsive.
  ...
  <Story name="Direction">
    {() => {
      ...
      const [valueVertical, setValueVertical] = useState([]);
        ...
        {
          id: 'chocolate_direction_vertical',
          value: 'chocolate',
          label: 'Chocolate',
        },
        {
          id: 'strawberry_direction_vertical',
          value: 'strawberry',
          label: 'Strawberry',
        },
        {
          id: 'vanilla_direction_vertical',
          value: 'vanilla',
          label: 'Vanilla',
        },
      ];
      const optionsHorizontal = [
        {
          id: 'chocolate_direction_horizontal',
          value: 'chocolate',
          label: 'Chocolate',
        },
        {
          id: 'strawberry_direction_horizontal',
          value: 'strawberry',
          label: 'Strawberry',
        },
        {
          id: 'vanilla_direction_horizontal',
          value: 'vanilla',
          label: 'Vanilla',
        },
      ];
...
NOTE: With vertically stacked options they will be fullWidth regardless since they are meant to be block-like elements.
