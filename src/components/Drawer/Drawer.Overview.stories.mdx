    ...
    {() => {
      ...
      return (
        <>
          ...
          <Drawer isOpen={isOpen} title="Drawer Title" onDismiss={close}>
    ...
    {() => {
      ...
      return (
        <Box display="block" childGap="md">
          ...
          <Drawer title="test" isOpen={isOpen} onDismiss={close} placement={value}>
            <Box padding="lg" display="block" childGap="md">
...
A header will be added to the drawer content if `title` is defined, or `closeButton` is `true`.

<Canvas>
  <Story name="Title and Close Button">
    {() => {
      const [isOpen, setIsOpen] = useState(false);
      const open = () => setIsOpen(true);
      const close = () => setIsOpen(false);
      return (
        <>
          ...
          <Drawer isOpen={isOpen} onDismiss={close} title="Drawer Title">
            <Box padding="lg" display="block" childGap="md">
              <Box>Drawer content&hellip;</Box>
              <Box>Drawer content&hellip;</Box>
              <Box>Drawer content&hellip;</Box>
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Drawer isOpen={isOpen} onDismiss={close} closeButton>
            <Box padding="lg" display="block" childGap="md">
              <Box>Drawer content&hellip;</Box>
              <Box>Drawer content&hellip;</Box>
              <Box>Drawer content&hellip;</Box>
...
The width of Drawers with a `left` or `right` placement can be set via `width`. The Drawer height will be 100% of the viewport, or if `containerRef` is used, 100% of the container.
...
<Canvas withSource="open">
  <Story name="Width">
    {() => {
      ...
      const widths = ['430px', '100%', '30rem', '4xl'];
      return (
        <>
          <Box childGap="sm" direction="row">
            {widths.map(width => (
              <Button variant="light" onClick={() => handleClick(width)} key={width}>
                {`Open ${width} Drawer `}
              </Button>
            ))}
          </Box>
          <Drawer width={width} isOpen={isOpen} onDismiss={close} closeButton>
            <Box padding="lg" display="block" childGap="md">
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Drawer placement="top" isOpen={isOpen} onDismiss={close} closeButton>
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Drawer isOpen={isOpen} onDismiss={close} hideOverlay closeButton>
            <Box padding="lg" display="block" childGap="md">
              <Box>drawer content</Box>
            </Box>
          </Drawer>
    ...
    {() => {
      ...
      return (
        <>
          ...
          <Drawer isOpen={isOpen} onDismiss={close} initialFocusRef={ref} title="intialFocusRef">
            <Box padding="lg" display="block" childGap="md">
              <Box>drawer content</Box>
