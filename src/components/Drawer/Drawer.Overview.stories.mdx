  ...
  >
    {() => {
      ...
      const {
        ...
        onClose: onDrawerClose,
      } = useDisclosure({ onClose: returnFocus });
      useEffect(() => {
        setTimeout(() => {
      ...
      return (
        <>
          <Button variant="light" onClick={onDrawerToggle} ref={returnFocusRef}>
            Toggle Drawer
          </Button>
          <Drawer
            isOpen={isDrawerOpen}
          ...
          >
            <Box padding="lg" display="block" childGap="md">
              <Button ref={closeBtnRef} onClick={onDrawerClose} variant="light">
                close
              </Button>
              <Box>drawer content</Box>
            </Box>
