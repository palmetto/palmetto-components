...
<Canvas>
  <Story name="Size">
    <Box childGap="md">
      <Box childGap="sm" direction="row">
        <Button size="xs" variant="primary">x-Small Primary</Button>
        <Button size="xs" variant="success">x-Small Success</Button>
        <Button size="xs" variant="danger">x-Small Danger</Button>
        <Button size="xs" variant="light">x-Small Light</Button>
        <Button size="xs" variant="dark">x-Small Dark</Button>
      </Box>
      <Box childGap="sm" direction="row">
        <Button size="xs" variant="primary" isOutlined>x-Small Primary</Button>
        <Button size="xs" variant="success" isOutlined>x-Small Success</Button>
        <Button size="xs" variant="danger" isOutlined>x-Small Danger</Button>
        <Button size="xs" variant="light" isOutlined>x-Small Light</Button>
        <Button size="xs" variant="dark" isOutlined>x-Small Dark</Button>
      </Box>
      <Box childGap="sm" direction="row">
