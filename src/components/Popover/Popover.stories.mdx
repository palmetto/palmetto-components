...
By default the Popover will render with placement === `right` as well as a white background, and some base padding on the container. All of these
...
<Canvas>
  <Story name="styling">
    {() => {
      ...
      const handleOpenPopover = () => { setPopoverOpen(!isPopoverOpen); };
      const [popoverBackground, setPopoverBackground] = useState({ value: 'white', label: 'White' });
      ...
      return (
        <Box height="400px">
          <Box direction="row" childGap="md" wrap>
            <Popover
              content={<><p>Hello world!</p><p>Style me any way you want</p></>}
              isOpen={isPopoverOpen}
              placement={'right'}
              contentContainerProps={{
                padding: 'sm',
          ...
          <Box direction="row" childGap="sm" wrap margin="3xl 0 0 0">
            <Box width="200px">
              <SelectInput
                ...
                onChange={(event) => { setPopoverBackground(event.target.value); }}
            ...
            <Box width="200px">
              <SelectInput
                ...
                onChange={(event) => { setPopoverFontColor(event.target.value); }}
            ...
            <Box width="200px">
              <SelectInput
                ...
                onChange={(event) => { setPopoverRadius(event.target.value); }}
                value={popoverRadius}
                label="Border Radius"
              />
            </Box>
...
event outside the Popover content. You can use the callback to set `isOpen` to false. 
