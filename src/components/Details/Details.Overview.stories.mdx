      ...
      return (
        <Details isOpen={isOpen}>
          ...
          <Box padding="md 0" childGap="sm">
            <Box fontSize="lg" as="h4">Leading the World Towards a Clean Energy Future</Box>
            <Box as="p">
...
<Canvas isExpanded>
  <Story name="With custom summary">
    {() => {
      ...
      return (
        <Details isOpen={isOpen}>
          <Details.Summary fontWeight="bold" color="primary-500" hover={{ color: 'primary-600'}} isDetailsOpen={isOpen} onToggle={onToggle}>
