...
<Meta title="Components/Form Inputs/TimePicker" component={TimePicker} />
...
_ABOUT TIME FORMAT:_ While the `value` prop technicall returns `{ label: string; value: string; }` the value returned will always
