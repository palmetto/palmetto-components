  ...
  <Story name="Responsive">
    {() => {
      const columnConfig = [
        ...
        {heading: 'Fifteenth Column', id: 'fifteenth'},
        {heading: 'Sixteenth Column', id: 'sixteenth'},
        {heading: 'Seventeenth Column', id: 'seventeenth'},
        {heading: 'Eighteenth Column', id: 'eighteenth'},
        {heading: 'Nineteenth Column', id: 'nineteenth'},
      ];
      const tableData = [
        ['1', 'foo', 'vanilla', 'Fran', 'BA', 'CA', 'DA', 'EA', 'FA', 'GA', 'HA', 'IA', 'JA', 'KA', 'LA', 'MA', 'NA', 'OA', 'PA'],
        ['2', 'bar', 'chocolate', 'Bob', 'BB', 'CB', 'DB', 'EB', 'FB', 'GB', 'HB', 'IB', 'JB', 'KB', 'LB', 'MB', 'NB', 'OB', 'PB'],
        ['3', 'bazz', 'strawberry', 'Cole', 'BC', 'CC', 'DC', 'EC', 'FC', 'GC', 'HC', 'IC', 'JC', 'KC', 'LC', 'MC', 'NC', 'OC', 'PB'],
      ];
      return (
        <Table
          columns={columnConfig}
