    ...
    {() => {
      ...
      return (
        <Table>
          ...
          <TableBody>
            {tableData.map(row => <TableRow data={row} id={row.id} />)}
          </TableBody>
        </Table>
      );
    }}
    ...
    {() => {
      ...
      return (
        <Table isResponsive>
          ...
          />
          <TableBody>
            {generateTableData().map(row => <TableRow data={row} id={row.id} />)}
          </TableBody>
        </Table>
      );
    }}
    ...
    {() => {
      ...
      return (
        <Table useFixedWidthColumns>
          <TableHead columns={columnConfig} />
          <TableBody>
            {tableData.map(row => <TableRow data={row} id={row.id} truncateOverflow />)}
          </TableBody>
        </Table>
      );
    }}
    ...
    {() => {
      ...
      return (
        <Table>
          <TableHead columns={columnConfig} />
          <TableBody>
            {tableData.map(row => <TableRow data={row} id={row.id} emptyCellPlaceholder="--" />)}
          </TableBody>
        </Table>
      );
    }}
