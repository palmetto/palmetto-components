    ...
    {() => {
      ...
      return (
        <Table
          isResponsive
        >
          <TableHead columns={columnConfig} onSort={handleTableHeaderClick} sortedColumn={sortedColumn} />
          <TableBody>
...
<Preview>
  <Story name="Sortable and Loading">
    {() => {
      ...
      return (
        <Table isLoading>
          <TableHead columns={columnConfig} onSort={handleTableHeaderClick} sortedColumn={sortedColumn} isLoading />
          <TableBody>
            {generateTableData().map(row => <TableRow data={row} key={row.id} />)}
          </TableBody>
        </Table>
    ...
    {() => {
      ...
      return (
        <Table useFixedWidthColumns>
          <TableHead columns={columnConfig} />
          <TableBody>
            {tableData.map(row => <TableRow data={row} key={row.id} truncateOverflow useFixed/>)}
          </TableBody>
        </Table>
      );
    }}
