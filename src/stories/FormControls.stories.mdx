    ...
    {() => {
      ...
      return (
        <Box direction="row" childGap="xs">
          ...
          <Box childGap="sm" alignItems="flex-start" justifyContent="flex-start">
          ...
          <Box childGap="sm" width="150px" alignItems="flex-start">
            <SelectInputNative
              id="smallSelect"
              label="Label"
          ...
          <Box childGap="sm" width="200px" alignItems="flex-start">
            <SelectInput
              id="smallMultiSelect"
              label="Label"
              onChange={event => handleChange('selectInput', event.target.value)}
